...
pub trait OngoingOperationModule {
    ...
    /// ```
    /// # use numbat_wasm::types::OperationCompletionStatus;
    /// # use numbat_wasm_modules::ongoing_operation::{
    /// #     self, CONTINUE_OP, DEFAULT_MIN_GAS_TO_SAVE_PROGRESS, STOP_OP,
    /// # };
    /// # pub trait ExampleContract: numbat_wasm::contract_base::ContractBase + ongoing_operation::OngoingOperationModule
    /// # {
