use numbat_wasm::types::{ContractCall, ContractDeploy};

use crate::DebugApi;

use super::{ScCallStep, ScDeployStep, ScQueryStep, TypedScCall, TypedScDeploy, TypedScQuery};

/// Converts a `ContractCall` or `ContractDeploy` into a denali object that additonally
...
/// Converts a `ContractCall` into a denali object that encodes a SC query.
