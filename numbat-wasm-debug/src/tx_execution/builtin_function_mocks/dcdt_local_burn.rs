...
use numbat_wasm::api::DCDT_LOCAL_BURN_FUNC_NAME;
...
pub fn execute_local_burn(tx_input: TxInput, tx_cache: TxCache) -> (TxResult, BlockchainUpdate) {
    if tx_input.args.len() != 2 {
        let err_result = TxResult::from_vm_error("DCDTLocalBurn expects 2 arguments".to_string());
    ...
    let dcdt_nft_create_log = TxLog {
        ...
        endpoint: DCDT_LOCAL_BURN_FUNC_NAME.to_vec(),
