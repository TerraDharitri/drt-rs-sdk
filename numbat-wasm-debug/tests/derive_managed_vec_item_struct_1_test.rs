use numbat_wasm::numbat_codec::test_util::{check_dep_encode_decode, check_top_encode_decode};
...
fn struct_1_static() {
    assert_eq!(
        <Struct1 as numbat_wasm::types::ManagedVecItem>::PAYLOAD_SIZE,
        16
    );
    assert!(<Struct1 as numbat_wasm::types::ManagedVecItem>::SKIPS_RESERIALIZATION);
}
...
fn struct_1_to_bytes_writer() {
    ...
    let mut arr: [u8; 16] = [0u8; <Struct1 as numbat_wasm::types::ManagedVecItem>::PAYLOAD_SIZE];

    <Struct1 as numbat_wasm::types::ManagedVecItem>::to_byte_writer(&s, |bytes| {
        arr[0..<Struct1 as numbat_wasm::types::ManagedVecItem>::PAYLOAD_SIZE]
...
fn struct_1_from_bytes_reader() {
    ...
    let struct_from_bytes =
        <Struct1 as numbat_wasm::types::ManagedVecItem>::from_byte_reader(|bytes| {
