...
// i.e. any types that are in scope and happen to have the same name as dharitri-sc-codec types do not break the build.
...
// Also adding all public functions exposed by dharitri-sc-codec.
