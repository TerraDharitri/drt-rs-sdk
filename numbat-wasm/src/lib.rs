...
pub trait ContractHookApi<BigInt, BigUint> {
    ...
    fn storage_load_cumulated_validator_reward(&self) -> BigUint {
        self.storage_load_big_uint(numbat_protected_storage::NUMBAT_REWARD_KEY)
    }
...
pub trait ContractIOApi<BigInt, BigUint> {
    ...
    fn get_argument_u64(&self, arg_id: i32) -> u64 {
        ...
        dcd_serde::bytes_to_number(bytes.as_slice(), false)
    }
    ...
    fn finish_u64(&self, value: u64) {
        let bytes = dcd_serde::u64_to_bytes(value);
    ...
    fn signal_sd_error(&self, ser_type: &str, type_name: &str, e: dcd_serde::SDError) -> ! {
