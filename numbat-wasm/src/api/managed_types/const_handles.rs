...
pub const CALL_VALUE_REWA: RawHandle = -11;
pub const CALL_VALUE_SINGLE_DCDT: RawHandle = -13;
...
pub const CALL_VALUE_MULTI_DCDT: RawHandle = -21;
pub const CALL_VALUE_SINGLE_DCDT_TOKEN_NAME: RawHandle = -22;
