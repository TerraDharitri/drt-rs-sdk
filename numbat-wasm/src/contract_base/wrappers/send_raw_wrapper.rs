    ...
    A: CallTypeApi,
{
    ...
    pub fn transfer_dcdt_execute(
        ...
        A::send_api_impl().transfer_dcdt_execute(
            to,
            token,
            amount,
            gas_limit,
    ...
    pub fn transfer_dcdt_execute(
        ...
        A::send_api_impl().transfer_dcdt_execute_legacy(
            &to.to_address(),
            token,
            amount,
            gas_limit,
    ...
    pub fn transfer_dcdt_nft_execute(
        ...
        A::send_api_impl().transfer_dcdt_nft_execute(
            to,
            token,
            nonce,
            amount,
    ...
    pub fn transfer_dcdt_nft_execute(
        ...
        A::send_api_impl().transfer_dcdt_nft_execute_legacy(
            &to.to_address(),
            token,
            nonce,
            amount,
    ...
    pub fn multi_dcdt_transfer_execute(
        ...
        A::send_api_impl().multi_transfer_dcdt_nft_execute_legacy(
            &to.to_address(),
            &payments_vec,
            gas_limit,
            &endpoint_name.to_boxed_bytes(),
