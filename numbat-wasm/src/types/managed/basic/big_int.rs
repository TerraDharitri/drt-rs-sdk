...
impl<M: ManagedTypeApi> CodecFrom<numbat_codec::num_bigint::BigInt> for BigInt<M> {}
#[cfg(feature = "num-bigint")]
impl<M: ManagedTypeApi> CodecFrom<BigInt<M>> for numbat_codec::num_bigint::BigInt {}

#[cfg(feature = "num-bigint")]
impl<M: ManagedTypeApi> From<&numbat_codec::num_bigint::BigInt> for BigInt<M> {
    fn from(alloc_big_int: &numbat_codec::num_bigint::BigInt) -> Self {
