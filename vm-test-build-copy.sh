...
build_and_copy() {
   ...
   cp $contract_path/output/*.drtsc.json \
      $vm_contract_path/output
   cp $contract_path/output/*.wasm \
      $vm_contract_path/output
   rm $vm_contract_path/output/*-dbg.drtsc.json
}
...
build_and_copy_with_scenarios ./contracts/feature-tests/dcdt-system-sc-mock $VM_REPO_PATH/test/features/dcdt-system-sc-mock
...
build_and_copy_composability() {
   ...
   cp -R contracts/feature-tests/composability/$contract/output/${contract}.drtsc.json \
      $VM_REPO_PATH/test/features/composability/$contract/output/${contract}.drtsc.json
