...
setLocalRoles() {
    local LOCAL_MINT_ROLE=0x45534454526f6c654c6f63616c4d696e74 # "DCDTRoleLocalMint"
    local LOCAL_BURN_ROLE=0x45534454526f6c654c6f63616c4275726e # "DCDTRoleLocalBurn"
