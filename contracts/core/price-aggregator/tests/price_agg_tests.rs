use numbat_sc_price_aggregator::{
    price_aggregator_data::{OracleStatus, TimestampedPrice, TokenPair},
    staking::StakingModule,
    PriceAggregator, MAX_ROUND_DURATION_SECONDS,
};
use numbat_wasm_debug::{managed_address, managed_biguint, managed_buffer, rust_biguint};
...
fn price_agg_submit_test() {
    let mut pa_setup = PriceAggSetup::new(numbat_sc_price_aggregator::contract_obj);
