    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn transfer_execute_fallible<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg2: ProxyArg<MultiValueEncoded<Env::Api, MultiValue3<RewaOrDcdtTokenIdentifier<Env::Api>, u64, BigUint<Env::Api>>>>,
    >(
        self,
        to: Arg0,
        endpoint_name: Arg1,
    ...
    pub fn nft_decode_complex_attributes<
        ...
        Arg6: ProxyArg<MultiValue5<BigUint<Env::Api>, ManagedBuffer<Env::Api>, DcdtTokenIdentifier<Env::Api>, bool, ManagedBuffer<Env::Api>>>,
    >(
        self,
        token_identifier: Arg0,
        amount: Arg1,
    ...
    pub fn last_issued_token(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, DcdtTokenIdentifier<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
