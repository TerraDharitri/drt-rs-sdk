...
pub trait Vault {
    ...
    #[endpoint]
    fn retrieve_funds_multi(&self, transfers: MultiValueEncoded<RewaOrDcdtTokenPaymentMultiValue>) {
    ...
    fn retrieve_funds_multi_event(
        &self,
        #[indexed] transfers: &MultiValueEncoded<RewaOrDcdtTokenPaymentMultiValue>,
    );
