...
pub trait ForwarderTransferExecuteModule {
    ...
    fn forward_transf_exec_accept_funds(&self, to: ManagedAddress) {
        ...
        self.vault_proxy()
            .contract(to)
            .accept_funds()
            .with_rewa_or_single_dcdt_token_transfer(token, token_nonce, payment)
            .transfer_execute();
    }
    ...
    fn forward_transf_execu_accept_funds_with_fees(
        ...
        self.vault_proxy()
            .contract(to)
            .accept_funds()
            .with_rewa_or_single_dcdt_token_transfer(token_id, 0, amount_to_send)
            .transfer_execute();
    }
    ...
    fn forward_transf_exec_accept_funds_twice(&self, to: ManagedAddress) {
        ...
        self.vault_proxy()
            .contract(to)
            .accept_funds()
            .with_rewa_or_single_dcdt_token_transfer(token, token_nonce, half_payment)
            .with_gas_limit(half_gas)
            .transfer_execute();
    }
    ...
    fn forward_transf_exec_accept_funds_return_values(
        ...
        self.vault_proxy()
            .contract(to)
            .accept_funds()
            .with_rewa_or_single_dcdt_token_transfer(token.clone(), token_nonce, payment)
            .transfer_execute();
