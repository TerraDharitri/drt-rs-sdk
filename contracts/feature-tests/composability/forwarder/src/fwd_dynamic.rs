    ...
    crate::fwd_nft::ForwarderNftModule + crate::fwd_storage::ForwarderStorageModule
{
    ...
    #[endpoint]
    fn change_to_dynamic(&self, token_id: DcdtTokenIdentifier) {
        self.send()
            .dcdt_system_sc_proxy()
    ...
    #[endpoint]
    fn update_token(&self, token_id: DcdtTokenIdentifier) {
        self.send()
            .dcdt_system_sc_proxy()
    ...
    #[endpoint]
    fn modify_royalties(&self, token_id: DcdtTokenIdentifier, nonce: u64, new_royalty: u64) {
        self.send()
    ...
    fn set_new_uris(
        ...
        self.send()
            .dcdt_nft_set_new_uris(&token_id, nonce, &new_uris);
    }

    #[endpoint]
    fn modify_creator(&self, token_id: DcdtTokenIdentifier, nonce: u64) {
        self.send().dcdt_nft_modify_creator(&token_id, nonce);
    }
    ...
    fn metadata_recreate(
        ...
        self.send().dcdt_metadata_recreate(
            token_id,
            nonce,
            name,
            royalties,
    ...
    fn metadata_update(
        ...
        self.send().dcdt_metadata_update(
            token_id,
            nonce,
            name,
            royalties,
