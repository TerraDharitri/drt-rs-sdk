    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn promise_raw_multi_transfer<
        ...
        Arg1: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg2: ProxyArg<u64>,
        Arg3: ProxyArg<MultiValueEncoded<Env::Api, DcdtTokenPaymentMultiValue<Env::Api>>>,
    >(
        self,
        to: Arg0,
        endpoint_name: Arg1,
    ...
    pub fn forward_sync_retrieve_funds_bt_multi<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<MultiValueEncoded<Env::Api, RewaOrDcdtTokenPaymentMultiValue<Env::Api>>>,
    >(
        self,
        to: Arg0,
        transfers: Arg1,
