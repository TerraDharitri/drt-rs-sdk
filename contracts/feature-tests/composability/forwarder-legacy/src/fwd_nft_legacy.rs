...
pub struct ComplexAttributes<M: ManagedTypeApi> {
    ...
    pub token_id: DcdtTokenIdentifier<M>,
    pub boolean: bool,
...
pub trait ForwarderNftModule: fwd_storage_legacy::ForwarderStorageModule {
    #[payable("*")]
    #[endpoint]
    fn buy_nft(&self, nft_id: DcdtTokenIdentifier, nft_nonce: u64, nft_amount: BigUint) -> BigUint {
    ...
    fn nft_decode_complex_attributes(
        ...
        hash: ManagedBuffer,
        uri: ManagedBuffer,
        attrs_arg: MultiValue5<BigUint, ManagedBuffer, DcdtTokenIdentifier, bool, ManagedBuffer>,
    ) {
    ...
    fn create_event(
        &self,
        #[indexed] token_id: &DcdtTokenIdentifier,
