...
const SC_SCENARIO_TESTER_PATH_EXPR: &str = "drtsc:output/scenario-tester.drtsc.json";
...
const CODE_PATH: DrtscPath = DrtscPath::new("output/scenario-tester.drtsc.json");
...
fn set_state_test() {
    ...
    world
        ...
        .nonce(3)
        .balance(50)
        .dcdt_nft_balance_and_attributes(NFT_ID, 2, 1, "")
        .commit();
    ...
    world
        ...
        .nonce(3)
        .balance(50)
        .dcdt_nft_balance_and_attributes(NFT_ID, 2, 1, FOURTH_ATTRIBUTES)
        .commit();
    ...
    world
        ...
        .nonce(2)
        .balance(30)
        .dcdt_nft_last_nonce(NFT_ID, 5);
    world
        .check_account(fifth)
        .nonce(2)
        .balance(30)
        .dcdt_nft_balance_and_attributes(NFT_ID, 5, 0, "");
