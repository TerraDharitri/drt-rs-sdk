...
fn setup() -> ScenarioWorld {
    ...
    world
        ...
        .nonce(1)
        .dcdt_balance(GOV_TOKEN_ID, INITIAL_GOV_TOKEN_BALANCE);
    world
...
pub fn propose(
    ...
    world
        ...
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, gov_token_amount))
        .whitebox(use_module::contract_obj, |sc| {
...
fn test_change_gov_config() {
    ...
    world
        ...
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 999))
    ...
    world
        ...
        .from(FIRST_USER_ADDRESS)
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 200))
        .whitebox(use_module::contract_obj, |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        });
    ...
    world
        ...
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(300u64));
    world
        .check_account(SECOND_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(1u64));
    world
        .check_account(THIRD_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(800u64));
    world
...
fn test_down_veto_gov_config() {
    ...
    world
        ...
        .from(FIRST_USER_ADDRESS)
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 300))
        .whitebox(use_module::contract_obj, |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        });
    ...
    world
        .check_account(FIRST_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(200u64));
...
fn test_abstain_vote_gov_config() {
    ...
    world
        ...
        .from(FIRST_USER_ADDRESS)
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 500))
        .whitebox(use_module::contract_obj, |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        });
    ...
    world
        ...
        .from(SECOND_USER_ADDRESS)
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 400))
        .whitebox(use_module::contract_obj, |sc| {
            sc.vote(proposal_id, VoteType::DownVote);
        });
    ...
    world
        ...
        .from(THIRD_USER_ADDRESS)
        .to(USE_MODULE_ADDRESS)
        .payment(TestDcdtTransfer(GOV_TOKEN_ID, 0, 600))
        .whitebox(use_module::contract_obj, |sc| {
    ...
    world
        .check_account(FIRST_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::zero());
    world
        .check_account(SECOND_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(600u64));
    world
        .check_account(THIRD_USER_ADDRESS)
        .dcdt_balance(GOV_TOKEN_ID, BigUint::from(400u64));
}
