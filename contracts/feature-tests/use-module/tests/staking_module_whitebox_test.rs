...
fn test_staking_module() {
    ...
    world
        ...
        .nonce(1)
        .dcdt_balance(STAKING_TOKEN_ID, INITIAL_BALANCE);
    world
        .account(BOB_ADDRESS)
        .nonce(1)
        .dcdt_balance(STAKING_TOKEN_ID, INITIAL_BALANCE);
    ...
    let new_address = world
        ...
        .whitebox(use_module::contract_obj, |sc| {
            ...
            sc.init_staking_module(
                &RewaOrDcdtTokenIdentifier::dcdt(STAKING_TOKEN_ID.to_token_identifier()),
    ...
    world
        ...
        .payment(TestDcdtTransfer(STAKING_TOKEN_ID, 0, REQUIRED_STAKE_AMOUNT))
    ...
    world
        ...
        .dcdt_balance(STAKING_TOKEN_ID, BigUint::from(1_000_000u64));
    ...
    world
        .check_account(ALICE_ADDRESS)
        .dcdt_balance(STAKING_TOKEN_ID, INITIAL_BALANCE - SLASH_AMOUNT);
}
