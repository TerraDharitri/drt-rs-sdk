...
//     numbat_wasm_debug::denali_rs("denali/crypto_elliptic_curves_legacy.scen.json", world());
// }

#[test]
fn crypto_keccak256_legacy_alloc_rs() {
    numbat_wasm_debug::denali_rs("denali/crypto_keccak256_legacy_alloc.scen.json", world());
}
...
fn crypto_sha256_legacy_alloc_rs() {
    numbat_wasm_debug::denali_rs("denali/crypto_sha256_legacy_alloc.scen.json", world());
}

// #[test]
// fn crypto_verify_bls_legacy_rs() {
//     numbat_wasm_debug::denali_rs("denali/crypto_verify_bls_legacy.scen.json", world());
// }

#[test]
fn crypto_verify_ed25519_legacy_rs() {
    numbat_wasm_debug::denali_rs("denali/crypto_verify_ed25519_legacy.scen.json", world());
}

// #[test]
// fn crypto_verify_secp256k1_legacy_rs() {
//     numbat_wasm_debug::denali_rs("denali/crypto_verify_secp256k1_legacy.scen.json", world());
// }
...
fn echo_big_int_nested_alloc_rs() {
    numbat_wasm_debug::denali_rs("denali/echo_big_int_nested_alloc.scen.json", world());
}
...
fn echo_multi_value_tuples_alloc_rs() {
    numbat_wasm_debug::denali_rs("denali/echo_multi_value_tuples_alloc.scen.json", world());
}
...
fn echo_varargs_u32_alloc_rs() {
    numbat_wasm_debug::denali_rs("denali/echo_varargs_u32_alloc.scen.json", world());
}
...
fn managed_buffer_load_slice_rs() {
    numbat_wasm_debug::denali_rs("denali/managed_buffer_load_slice.scen.json", world());
}
...
fn managed_buffer_set_slice_rs() {
    numbat_wasm_debug::denali_rs("denali/managed_buffer_set_slice.scen.json", world());
}

#[test]
fn only_owner_legacy_rs() {
    numbat_wasm_debug::denali_rs("denali/only_owner_legacy.scen.json", world());
}
...
fn storage_address_rs() {
    numbat_wasm_debug::denali_rs("denali/storage_address.scen.json", world());
}

#[test]
fn storage_opt_address_rs() {
    numbat_wasm_debug::denali_rs("denali/storage_opt_address.scen.json", world());
}
