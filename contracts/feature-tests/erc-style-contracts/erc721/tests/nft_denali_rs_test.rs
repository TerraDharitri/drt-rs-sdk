...
fn nft_approve_non_existent_token_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-approve-non-existent-token.scen.json", world());
}

#[test]
fn nft_approve_non_owned_token_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-approve-non-owned-token.scen.json", world());
}

#[test]
fn nft_approve_ok_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-approve-ok.scen.json", world());
}

#[test]
fn nft_init_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-init.scen.json", world());
}
...
fn nft_revoke_non_approved_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-revoke-non-approved.scen.json", world());
}

#[test]
fn nft_revoke_ok_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-revoke-ok.scen.json", world());
}

#[test]
fn nft_transfer_approved_token_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-transfer-approved-token.scen.json", world());
}

#[test]
fn nft_transfer_non_existent_token_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-transfer-non-existent-token.scen.json", world());
}
...
fn nft_transfer_ok_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-transfer-ok.scen.json", world());
}

#[test]
fn nft_transfer_token_after_revoked_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-transfer-token-after-revoked.scen.json", world());
}
...
fn nft_transfer_token_ok_rs() {
    numbat_wasm_debug::denali_rs("denali/nft-transfer-token-ok.scen.json", world());
}
