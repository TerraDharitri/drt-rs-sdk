...
fn world() -> ScenarioWorld {
    ...
    blockchain.set_current_dir_from_workspace("contracts/feature-tests/erc-style-contracts/erc721");
    blockchain.register_contract("drtsc:output/erc721.drtsc.json", erc721::ContractBuilder);
    blockchain
}
