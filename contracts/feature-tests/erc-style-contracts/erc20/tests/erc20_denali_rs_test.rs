...
fn allowance_callercaller_rs() {
    numbat_wasm_debug::denali_rs("denali/allowance_CallerCaller.scen.json", world());
}

#[test]
fn allowance_callerother_rs() {
    numbat_wasm_debug::denali_rs("denali/allowance_CallerOther.scen.json", world());
}

#[test]
fn allowance_othercaller_rs() {
    numbat_wasm_debug::denali_rs("denali/allowance_OtherCaller.scen.json", world());
}

#[test]
fn allowance_othereqother_rs() {
    numbat_wasm_debug::denali_rs("denali/allowance_OtherEqOther.scen.json", world());
}

#[test]
fn allowance_otherneqother_rs() {
    numbat_wasm_debug::denali_rs("denali/allowance_OtherNEqOther.scen.json", world());
}

#[test]
fn approve_caller_positive_rs() {
    numbat_wasm_debug::denali_rs("denali/approve_Caller-Positive.scen.json", world());
}

#[test]
fn approve_caller_zero_rs() {
    numbat_wasm_debug::denali_rs("denali/approve_Caller-Zero.scen.json", world());
}

#[test]
fn approve_other_positive_rs() {
    numbat_wasm_debug::denali_rs("denali/approve_Other-Positive.scen.json", world());
}

#[test]
fn approve_other_zero_rs() {
    numbat_wasm_debug::denali_rs("denali/approve_Other-Zero.scen.json", world());
}

#[test]
fn approve_switchcaller_rs() {
    numbat_wasm_debug::denali_rs("denali/approve_SwitchCaller.scen.json", world());
}

#[test]
fn balanceof_caller_rs() {
    numbat_wasm_debug::denali_rs("denali/balanceOf_Caller.scen.json", world());
}

#[test]
fn balanceof_noncaller_rs() {
    numbat_wasm_debug::denali_rs("denali/balanceOf_NonCaller.scen.json", world());
}

#[test]
fn not_payable_rs() {
    numbat_wasm_debug::denali_rs("denali/not_payable.scen.json", world());
}

#[test]
fn totalsupply_positive_rs() {
    numbat_wasm_debug::denali_rs("denali/totalSupply_Positive.scen.json", world());
}

#[test]
fn totalsupply_zero_rs() {
    numbat_wasm_debug::denali_rs("denali/totalSupply_Zero.scen.json", world());
}
...
fn transferfrom_fromeqto_nooverflow_rs() {
    numbat_wasm_debug::denali_rs("denali/transferFrom_FromEqTo-NoOverflow.scen.json", world());
}
...
fn transfer_caller_entirebalance_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-EntireBalance.scen.json", world());
}

#[test]
fn transfer_caller_morethanbalance_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-MoreThanBalance.scen.json", world());
}

#[test]
fn transfer_caller_nooverflow_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-NoOverflow.scen.json", world());
}

#[test]
fn transfer_caller_positive_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-Positive.scen.json", world());
}

#[test]
fn transfer_caller_stillnooverflow_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-StillNoOverflow.scen.json", world());
}

#[test]
fn transfer_caller_zero_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Caller-Zero.scen.json", world());
}
...
fn transfer_other_entirebalance_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-EntireBalance.scen.json", world());
}

#[test]
fn transfer_other_morethanbalance_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-MoreThanBalance.scen.json", world());
}

#[test]
fn transfer_other_nooverflow_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-NoOverflow.scen.json", world());
}

#[test]
fn transfer_other_positive_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-Positive.scen.json", world());
}

#[test]
fn transfer_other_stillnooverflow_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-StillNoOverflow.scen.json", world());
}

#[test]
fn transfer_other_zero_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_Other-Zero.scen.json", world());
}
