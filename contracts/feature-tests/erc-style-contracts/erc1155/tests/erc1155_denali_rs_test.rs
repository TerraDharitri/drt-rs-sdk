...
fn create_token_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/create_token_fungible.scen.json", world());
}

#[test]
fn create_token_non_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/create_token_non_fungible.scen.json", world());
}
...
fn transfer_fungible_ok_test_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_fungible_ok.scen.json", world());
}
...
fn transfer_non_fungible_ok_test_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_non_fungible_ok.scen.json", world());
}

#[test]
fn batch_transfer_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/batch_transfer_fungible.scen.json", world());
}

#[test]
fn batch_transfer_non_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/batch_transfer_non_fungible.scen.json", world());
}

#[test]
fn batch_transfer_both_types_test_rs() {
    numbat_wasm_debug::denali_rs("denali/batch_transfer_both_types.scen.json", world());
}

#[test]
fn transfer_fungible_ok_to_sc_test_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_fungible_ok_to_sc.scen.json", world());
}

#[test]
fn transfer_non_fungible_ok_to_sc_test_rs() {
    numbat_wasm_debug::denali_rs("denali/transfer_non_fungible_ok_to_sc.scen.json", world());
}

#[test]
fn batch_transfer_fungible_to_sc_test_rs() {
    numbat_wasm_debug::denali_rs("denali/batch_transfer_fungible_to_sc.scen.json", world());
}
...
fn batch_transfer_both_types_to_sc_test_rs() {
    numbat_wasm_debug::denali_rs("denali/batch_transfer_both_types_to_sc.scen.json", world());
}
...
fn mint_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/mint_fungible.scen.json", world());
}

#[test]
fn mint_non_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/mint_non_fungible.scen.json", world());
}

#[test]
fn mint_not_creator_test_rs() {
    numbat_wasm_debug::denali_rs("denali/mint_not_creator.scen.json", world());
}
...
fn burn_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/burn_fungible.scen.json", world());
}

#[test]
fn burn_non_fungible_test_rs() {
    numbat_wasm_debug::denali_rs("denali/burn_non_fungible.scen.json", world());
}
