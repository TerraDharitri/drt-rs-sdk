...
use dharitri_sc_snippets::{
    imports::{
        BigUint, DCDTSystemSCAddress, DCDTSystemSCProxy, DcdtLocalRole, DcdtTokenPayment,
        DcdtTokenType, FungibleTokenProperties, ManagedBuffer, ManagedDecimal, ManagedOption,
        ManagedVec, ReturnsNewTokenIdentifier, RewaDecimals, RustBigUint, StaticApi,
        TokenIdentifier,
    },
...
#[serial]
#[cfg_attr(not(feature = "chain-simulator-tests"), ignore)]
async fn send_dcdt_to_non_existent_address_test() {
