...
const MANAGED_MAP_CODE_PATH: DrtscPath = DrtscPath::new("output/basic-features.drtsc.json");
...
fn world() -> ScenarioWorld {
    ...
    blockchain
        ...
        .storage_denali("str:mm-num-entries", "3")
        .storage_denali("str:mm-key|u32:0", "str:key0")
        .storage_denali("str:mm-key|u32:1", "str:key1")
        .storage_denali("str:mm-key|u32:2", "str:key2")
        .storage_denali("str:mm-value|u32:0", "str:value0")
        .storage_denali("str:mm-value|u32:1", "str:value1")
        .storage_denali("str:mm-value|u32:2", "str:value2")
        .commit();
