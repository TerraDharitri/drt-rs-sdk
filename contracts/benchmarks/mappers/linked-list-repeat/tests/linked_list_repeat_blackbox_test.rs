...
const WASM_PATH: DrtscPath = DrtscPath::new("output/linked-list-repeat.drtsc.json");
...
fn linked_list_repeat_struct_blackbox_raw() {
    ...
    let mut example = ExampleStruct {
        first_token_id: DcdtTokenIdentifier::from_dcdt_bytes(b"str:TESTTOK-1234"),
        first_token_nonce: 0,
        first_token_amount: dharitri_sc::types::BigUint::from(1_000_000_000_000_000_000u64),
        second_token_id: DcdtTokenIdentifier::from_dcdt_bytes(b"str:TESTTOK-2345"),
