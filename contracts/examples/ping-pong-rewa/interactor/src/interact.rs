...
use ping_pong_rewa::proxy_ping_pong_rewa::{self, ContractState, UserStatus};
...
impl PingPongRewaInteract {
    pub async fn init(config: Config) -> Self {
        ...
        interactor.set_current_dir_from_workspace("contracts/examples/ping-pong-rewa/interactor");
