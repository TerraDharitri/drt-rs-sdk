...
const GATEWAY: &str = dharitri_sc_snippets::sdk::gateway::DEVNET_GATEWAY;
const CONTRACT_ADDRESS: &str = "drt1qqqqqqqqqqqqqpgq6tqvj5f59xrgxwrtwy30elgpu7l4zrv6d8ssww6d97";
const PING_PONG_CODE: &[u8] = include_bytes!("../ping-pong-rewa.wasm");
...
impl ContractInteract {
    pub async fn new() -> Self {
        ...
        interactor.set_current_dir_from_workspace("contracts/examples/ping-pong-rewa/dapp");
