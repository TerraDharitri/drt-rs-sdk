...
from drtpy import config
from drtpy.accounts import Account
from drtpy.contracts import SmartContract
from drtpy.environments import TestnetEnvironment
from drtpy.projects import ProjectRust
from drtpy.proxy import NumbatProxy
...
if __name__ == '__main__':
    ...
    user.sync_nonce(NumbatProxy(args.proxy))
