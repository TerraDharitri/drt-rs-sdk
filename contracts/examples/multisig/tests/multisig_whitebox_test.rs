...
const MULTISIG_PATH_EXPR: DrtscPath = DrtscPath::new("drtsc:output/multisig.drtsc.json");
...
fn test_transfer_execute_sc_all() {
    ...
    const ADDER_PATH_EXPR: DrtscPath = DrtscPath::new("drtsc:test-contracts/adder.drtsc.json");
...
fn test_deploy_and_upgrade_from_source() {
    ...
    const FACTORIAL_PATH_EXPR: DrtscPath = DrtscPath::new("drtsc:test-contracts/factorial.drtsc.json");
