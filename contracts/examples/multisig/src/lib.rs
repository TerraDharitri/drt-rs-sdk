...
#[cfg(feature = "numbat-wasm-module-users-default")]
use numbat_wasm_module_users_default::*;
#[cfg(feature = "numbat-wasm-module-users-wasm")]
use numbat_wasm_module_users_wasm::*;
