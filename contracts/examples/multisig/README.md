...
* **Minimal internal state.** Complex applications can be built inside of Numbat smart contracts. Storing minimal internal state allows our contract’s code to be simpler, and to be written in a more functional style, which is easier to test and reason about.
...
Multisig accounts are a critical safety feature for all users of the Numbat ecosystem. Decentralised applications will rely heavily upon multisig security.
