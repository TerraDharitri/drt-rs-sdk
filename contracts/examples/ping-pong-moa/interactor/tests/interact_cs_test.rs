...
use ping_pong_moa_interact::{Config, PingPongMoaInteract};

#[tokio::test]
#[cfg_attr(not(feature = "chain-simulator-tests"), ignore)]
async fn test_ping_pong_moa() {
    let mut interact = PingPongMoaInteract::init(Config::chain_simulator_config()).await;
