...
drtjs.print(Rewa.raw(await crowdfunding.query.get_target()));
...
let aliceBalanceBefore = await drtSys.getBalance(alice, Rewa);
...
let aliceBalanceAfter = await drtSys.getBalance(alice, Rewa);
