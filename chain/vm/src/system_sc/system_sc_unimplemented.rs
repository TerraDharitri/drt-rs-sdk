...
pub fn register_meta_dcdt(tx_input: TxInput, tx_cache: TxCache) -> (TxResult, BlockchainUpdate) {
    unimplemented!()
}
...
pub fn dcdt_burn(tx_input: TxInput, tx_cache: TxCache) -> (TxResult, BlockchainUpdate) {
    unimplemented!()
}
