use dharitri_chain_core::types::CodeMetadata;
...
use crate::{
    ...
    system_sc::DCDT_SYSTEM_SC_ADDRESS_ARRAY, types::VMAddress,
};
...
impl Default for BlockchainState {
    fn default() -> Self {
        ...
        state.add_empty_account(DCDT_SYSTEM_SC_ADDRESS_ARRAY.into());
    ...
    fn add_empty_account(&mut self, address: VMAddress) {
        self.accounts.insert(
            ...
            AccountData {
                address,
                nonce: 0,
                rewa_balance: Default::default(),
                dcdt: Default::default(),
                username: Vec::new(),
                storage: HashMap::new(),
                contract_path: None,
