...
impl<C: VMHooksContext> VMHooks for VMHooksDispatcher<C> {
    ...
    fn get_dcdt_balance(
        ...
        panic!("Unavailable: get_dcdt_balance")
    }

    fn get_dcdt_nft_name_length(
        &mut self,
        address_offset: MemPtr,
        token_id_offset: MemPtr,
        token_id_len: MemLength,
        ...
        panic!("Unavailable: get_dcdt_nft_name_length")
    }

    fn get_dcdt_nft_attribute_length(
        &mut self,
        address_offset: MemPtr,
        token_id_offset: MemPtr,
        token_id_len: MemLength,
        ...
        panic!("Unavailable: get_dcdt_nft_attribute_length")
    }

    fn get_dcdt_nft_uri_length(
        &mut self,
        address_offset: MemPtr,
        token_id_offset: MemPtr,
        token_id_len: MemLength,
        ...
        panic!("Unavailable: get_dcdt_nft_uri_length")
    }
    ...
    fn get_dcdt_token_data(
        ...
        panic!("Unavailable: get_dcdt_token_data")
    }

    fn get_dcdt_local_roles(&mut self, token_id_handle: i32) -> Result<i64, VMHooksEarlyExit> {
        self.handler.get_dcdt_local_roles_bits(token_id_handle)
    }
    ...
    fn transfer_dcdt_execute(
        ...
        panic!("Unavailable: transfer_dcdt_execute")
    }

    fn transfer_dcdt_nft_execute(
        &mut self,
        dest_offset: MemPtr,
        token_id_offset: MemPtr,
        token_id_len: MemLength,
        ...
        panic!("Unavailable: transfer_dcdt_nft_execute")
    }

    fn multi_transfer_dcdt_nft_execute(
        &mut self,
        dest_offset: MemPtr,
        ...
        panic!("Unavailable: multi_transfer_dcdt_nft_execute")
    }
    ...
    fn get_dcdt_value(&mut self, result_offset: MemPtr) -> Result<i32, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_value")
    }

    fn get_dcdt_value_by_index(
        &mut self,
        result_offset: MemPtr,
        index: i32,
    ) -> Result<i32, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_value_by_index")
    }

    fn get_dcdt_token_name(&mut self, result_offset: MemPtr) -> Result<i32, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_token_name")
    }

    fn get_dcdt_token_name_by_index(
        &mut self,
        result_offset: MemPtr,
        index: i32,
    ) -> Result<i32, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_token_name_by_index")
    }

    fn get_dcdt_token_nonce(&mut self) -> Result<i64, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_token_nonce")
    }

    fn get_dcdt_token_nonce_by_index(&mut self, index: i32) -> Result<i64, VMHooksEarlyExit> {
        panic!("Unavailable: get_dcdt_token_nonce_by_index")
    }
    ...
    fn managed_get_multi_dcdt_call_value(
        &mut self,
        multi_call_value_handle: i32,
    ) -> Result<(), VMHooksEarlyExit> {
        self.handler
            .load_all_dcdt_transfers(multi_call_value_handle)
    }

    fn managed_get_dcdt_balance(
        &mut self,
        address_handle: i32,
        token_id_handle: i32,
        nonce: i64,
        ...
        panic!("Unavailable: managed_get_dcdt_balance");
    }
    ...
    fn managed_get_dcdt_token_data(
        ...
        self.handler.managed_get_dcdt_token_data(
            address_handle,
            token_id_handle,
            nonce as u64,
            value_handle,
    ...
    fn managed_get_dcdt_token_type(
        &mut self,
        address_handle: i32,
        token_id_handle: i32,
        nonce: i64,
        ...
        self.handler.managed_get_dcdt_token_type(
            address_handle,
            token_id_handle,
            nonce,
            type_handle,
    ...
    fn managed_get_back_transfers(
        &mut self,
        dcdt_transfer_value_handle: i32,
    ...
    fn managed_multi_transfer_dcdt_nft_execute(
        &mut self,
        dst_handle: i32,
        ...
        self.handler.multi_transfer_dcdt_nft_execute(
            dst_handle,
    ...
    fn managed_multi_transfer_dcdt_nft_execute_with_return(
        &mut self,
        dst_handle: i32,
        token_transfers_handle: i32,
        gas_limit: i64,
        ...
        self.handler
            .managed_multi_transfer_dcdt_nft_execute_with_return(
                dst_handle,
                token_transfers_handle,
                gas_limit as u64,
                function_handle,
    ...
    fn managed_is_dcdt_frozen(
        &mut self,
        address_handle: i32,
        token_id_handle: i32,
        nonce: i64,
    ) -> Result<i32, VMHooksEarlyExit> {
        map_bool_to_i32(self.handler.check_dcdt_frozen(
            address_handle,
            token_id_handle,
            nonce as u64,
        ))
    ...
    fn managed_is_dcdt_limited_transfer(
        &mut self,
    ...
    fn managed_is_dcdt_paused(&mut self, _token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
        map_bool_to_i32(Ok(false))
    }
    ...
    fn big_int_get_dcdt_call_value(&mut self, destination: i32) -> Result<(), VMHooksEarlyExit> {
        panic!("Unavailable: big_int_get_dcdt_call_value");
    }

    fn big_int_get_dcdt_call_value_by_index(
        &mut self,
        destination_handle: i32,
        index: i32,
    ) -> Result<(), VMHooksEarlyExit> {
        panic!("Unavailable: big_int_get_dcdt_call_value_by_index");
    }
    ...
    fn big_int_get_dcdt_external_balance(
        ...
        unsafe {
            ...
            let token_id_bytes = self
                ...
                .context
                .memory_load(token_id_offset, token_id_len);
            self.handler.big_int_get_dcdt_external_balance(
                &address_bytes,
                &token_id_bytes,
                nonce as u64,
                result_handle,
