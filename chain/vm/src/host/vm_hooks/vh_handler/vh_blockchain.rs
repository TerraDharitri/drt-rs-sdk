...
impl<C: VMHooksContext> VMHooksHandler<C> {
    ...
    pub fn big_int_get_dcdt_external_balance(
        &mut self,
        address_bytes: &[u8],
        token_id_bytes: &[u8],
        nonce: u64,
        ...
        self.context
            .m_types_lock()
            .bi_overwrite(dest, dcdt_balance.into());
    ...
    pub fn managed_get_dcdt_token_data(
        &mut self,
    ...
    pub fn managed_get_dcdt_token_type(
        &mut self,
        _address_handle: i32,
        ...
        let token_type = DcdtTokenType::based_on_token_nonce(nonce as u64);
    ...
    pub fn managed_get_back_transfers(
        ...
        let num_bytes_copied = m_types.mb_set_vec_of_dcdt_payments(
    ...
    pub fn get_dcdt_local_roles_bits(
        &mut self,
        token_id_handle: RawHandle,
    ) -> Result<i64, VMHooksEarlyExit> {
        self.use_gas(
    ...
    pub fn validate_token_identifier(
        ...
        Ok(dharitri_chain_core::token_identifier_util::validate_token_identifier(token_id))
    }
