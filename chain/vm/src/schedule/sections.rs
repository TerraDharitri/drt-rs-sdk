...
pub struct BuiltInCost {
    ...
    #[serde(rename = "DCDTTransfer")]
    pub dcdt_transfer: u64,
    #[serde(rename = "DCDTBurn")]
    pub dcdt_burn: u64,
    #[serde(rename = "DCDTLocalMint")]
    pub dcdt_local_mint: u64,
    #[serde(rename = "DCDTLocalBurn")]
    pub dcdt_local_burn: u64,
    #[serde(rename = "DCDTNFTCreate")]
    pub dcdtnft_create: u64,
    #[serde(rename = "DCDTNFTAddQuantity")]
    pub dcdtnft_add_quantity: u64,
    #[serde(rename = "DCDTNFTBurn")]
    pub dcdtnft_burn: u64,
    #[serde(rename = "DCDTNFTTransfer")]
    pub dcdtnft_transfer: u64,
    #[serde(rename = "DCDTNFTChangeCreateOwner")]
    pub dcdtnft_change_create_owner: u64,
    #[serde(rename = "DCDTNFTAddUri")]
    pub dcdtnft_add_uri: u64,
    #[serde(rename = "DCDTNFTUpdateAttributes")]
    pub dcdtnft_update_attributes: u64,
    #[serde(rename = "DCDTNFTMultiTransfer")]
    pub dcdtnft_multi_transfer: u64,
    #[serde(rename = "MultiDCDTNFTTransfer")]
    pub multi_dcdtnft_transfer: u64,
    #[serde(rename = "DCDTModifyRoyalties")]
    pub dcdt_modify_royalties: u64,
    #[serde(rename = "DCDTModifyCreator")]
    pub dcdt_modify_creator: u64,
    #[serde(rename = "DCDTNFTRecreate")]
    pub dcdtnft_recreate: u64,
    #[serde(rename = "DCDTNFTUpdate")]
    pub dcdtnft_update: u64,
    #[serde(rename = "DCDTNFTSetNewURIs")]
    pub dcdtnft_set_new_ur_is: u64,
...
pub struct MetaChainSystemSCsCost {
    ...
    #[serde(rename = "DCDTIssue")]
    pub dcdt_issue: u64,
    #[serde(rename = "DCDTOperations")]
    pub dcdt_operations: u64,
