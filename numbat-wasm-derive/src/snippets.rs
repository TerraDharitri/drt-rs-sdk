...
pub fn contract_imports() -> proc_macro2::TokenStream {
    quote! {
        use numbat_wasm::{Box, Vec, String};
        use numbat_wasm::{H256, Address, StorageKey, ErrorMessage};
        use numbat_wasm::{ContractHookApi, ContractIOApi, BigIntApi, BigUintApi, OtherContractHandle, AsyncCallResult, AsyncCallError};
