        ...
        "Address" | "StorageKey" | "H256" =>
            quote!{
                match cb_data_deserializer.next_h256() {
                    numbat_wasm::DeserializerResult::NoMore => self.api.signal_error(err_msg::ARG_ASYNC_RETURN_WRONG_NUMBER),
                    numbat_wasm::DeserializerResult::Err(e) => self.api.signal_error(e),
                    numbat_wasm::DeserializerResult::Res(h256) => h256,
                }
            },
        other_stype_str => {
