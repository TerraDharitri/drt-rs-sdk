...
use dharitri_sc::{api::uncallable::UncallableApi, formatter::*, types::CodeMetadata};
...
impl FormatByteReceiver for SimpleReceiver {
    ...
    fn append_managed_buffer(&mut self, _item: &dharitri_sc::types::ManagedBuffer<UncallableApi>) {
        unimplemented!()
    }

    fn append_managed_buffer_lower_hex(
        &mut self,
        _item: &dharitri_sc::types::ManagedBuffer<UncallableApi>,
    ) {
        unimplemented!()
    }
