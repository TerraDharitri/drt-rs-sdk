use crate::{
    ...
    types::{ManagedVecRef, RewaOrDcdtTokenIdentifier},
};

use crate::{
    abi::{TypeAbi, TypeName},
    api::ManagedTypeApi,
    types::{BigUint, ManagedVecItem, RewaOrDcdtTokenPayment, TokenIdentifier},
};
...
impl<M> MultiValueConstLength for RewaOrDcdtTokenPaymentMultiValue<M>
where
    M: ManagedTypeApi,
{
