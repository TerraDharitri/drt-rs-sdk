use crate::{
    ...
    types::{DcdtTokenPayment, ManagedVec, ManagedVecItem},
};
...
impl<M: ManagedTypeApi> Mergeable<M> for DcdtTokenPayment<M> {
    fn can_merge_with(&self, other: &Self) -> bool {
...
impl<M: ManagedTypeApi> ExternallyMergeable<M> for DcdtTokenPayment<M> {
    fn can_be_merged_externally_with(&self, other: &Self) -> bool {
