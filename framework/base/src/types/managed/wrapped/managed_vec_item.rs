...
use crate::{
    ...
    types::{
        BigInt, BigUint, EllipticCurve, DcdtTokenIdentifier, ManagedAddress, ManagedBuffer,
        ManagedByteArray, ManagedRef, ManagedType, ManagedVec, NonZeroBigUint, TokenId,
    },
};

use super::{
    RewaOrDcdtTokenIdentifier, ManagedVecItemPayload, ManagedVecItemPayloadAdd,
...
impl_managed_type! {DcdtTokenIdentifier}
...
where
    T1: ManagedVecItem,
    T2: ManagedVecItem,
    (T1, (T2, ())): ManagedVecItemStructPayloadTuple,
{
...
where
    ...
    T2: ManagedVecItem,
    T3: ManagedVecItem,
    (T1, (T2, (T3, ()))): ManagedVecItemStructPayloadTuple,
{
