...
// const + const
impl<M: ManagedTypeApi, DECIMALS: Unsigned> Sub<ManagedDecimalSigned<M, ConstDecimals<DECIMALS>>>
...
// var + const
impl<DECIMALS: Unsigned, M: ManagedTypeApi> Sub<ManagedDecimalSigned<M, ConstDecimals<DECIMALS>>>
    for ManagedDecimalSigned<M, NumDecimals>
{
...
// const + var
impl<DECIMALS: Unsigned, M: ManagedTypeApi> Sub<ManagedDecimalSigned<M, NumDecimals>>
    for ManagedDecimalSigned<M, ConstDecimals<DECIMALS>>
{
    type Output = ManagedDecimalSigned<M, NumDecimals>;
