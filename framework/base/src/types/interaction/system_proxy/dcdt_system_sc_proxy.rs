...
use crate::{
    api::CallTypeApi,
    types::{
        BigUint, RewaPayment, DcdtLocalRole, DcdtTokenIdentifier, DcdtTokenType, FunctionCall,
...
pub type IssueCall<Env, From, To, Gas> = Tx<
    ...
    OriginalResultMarker<DcdtTokenIdentifier<<Env as TxEnv>::Api>>,
>;
    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn mint<
        Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>,
    ...
    pub fn pause<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_identifier: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
    ...
    pub fn unpause<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_identifier: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
    ...
    pub fn change_sft_to_meta_dcdt<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_identifier: Arg0,
        num_decimals: usize,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
    ...
    pub fn set_special_roles<
        ...
        Arg1: ProxyArg<DcdtTokenIdentifier<Env::Api>>,
    >(
        self,
        address: Arg0,
    ...
    pub fn get_special_roles<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_identifier: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        let tx = self
    ...
    pub fn control_changes<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_identifier: Arg0,
    ...
    pub fn change_to_dynamic<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_id: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
    ...
    pub fn update_token<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_id: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
    ...
    pub fn get_token_properties<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_id: Arg0,
