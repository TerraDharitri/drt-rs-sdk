use dharitri_sc_codec::{Empty, TopEncode};
...
use crate::chain_core::builtin_func_names::{
    ...
    DCDT_LOCAL_MINT_FUNC_NAME, DCDT_METADATA_RECREATE_FUNC_NAME, DCDT_METADATA_UPDATE_FUNC_NAME,
    DCDT_MODIFY_CREATOR_FUNC_NAME, DCDT_MODIFY_ROYALTIES_FUNC_NAME,
    ...
    DELETE_USERNAME_FUNC_NAME, SET_USERNAME_FUNC_NAME,
};
