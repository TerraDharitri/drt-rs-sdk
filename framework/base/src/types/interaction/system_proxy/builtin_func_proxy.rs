...
use crate::types::{
    BigUint, DcdtTokenIdentifier, ManagedAddress, ManagedBuffer, ManagedVec, NotPayable, ProxyArg,
    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn nft_add_multiple_uri<Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_id: Arg0,
        nft_nonce: u64,
    ...
    pub fn nft_update_attributes<T: TopEncode, Arg0: ProxyArg<DcdtTokenIdentifier<Env::Api>>>(
        self,
        token_id: Arg0,
        nft_nonce: u64,
        new_attributes: &T,
