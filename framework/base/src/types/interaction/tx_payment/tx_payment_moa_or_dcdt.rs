use crate::types::{BigUint, Moa, MoaOrDcdtTokenPayment, ManagedAddress, TxFrom, TxToSpecified};

use super::{FullPaymentData, FunctionCall, TxEnv, TxPayment};

impl<Env> TxPayment<Env> for &MoaOrDcdtTokenPayment<Env::Api>
where
    Env: TxEnv,
{
    ...
    fn perform_transfer_execute(
        ...
        self.map_ref_moa_or_dcdt(
            (to, fc),
            |(to, fc), amount| Moa(amount).perform_transfer_execute(env, to, gas_limit, fc),
