...
use crate::{
    ...
    types::{BigUint, ManagedAddress, ManagedRef, MultiMoaOrDcdtPayment, TxFrom, TxToSpecified},
};

use super::{FullPaymentData, FunctionCall, TxEnv, TxPayment};

impl<Env> TxPayment<Env> for &MultiMoaOrDcdtPayment<Env::Api>
where
    Env: TxEnv,
{
    ...
    fn perform_transfer_execute(
        ...
        let _ = SendRawWrapper::<Env::Api>::new().multi_moa_or_dcdt_transfer_execute(
            to,
            self,
            gas_limit,
            &fc.function_name,
...
impl<Env> TxPayment<Env> for ManagedRef<'_, Env::Api, MultiMoaOrDcdtPayment<Env::Api>>
where
    Env: TxEnv,
{
    #[inline]
