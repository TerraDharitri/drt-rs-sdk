    ...
    P: MultiTransferMarkerArg + AsRef<PaymentVec<Env::Api>>,
{
    ...
    fn perform_transfer_execute_fallible(
        ...
        SendRawWrapper::<Env::Api>::new().multi_rewa_or_dcdt_transfer_execute_fallible(
            to,
            pv.as_multi_rewa_or_dcdt_payment(),
            gas_limit,
            &fc.function_name,
            &fc.arg_buffer,
        )
    ...
    fn perform_transfer_execute_legacy(
        ...
        let pv = self.0.as_ref();
        SendRawWrapper::<Env::Api>::new().multi_rewa_or_dcdt_transfer_execute(
            to,
            pv.as_multi_rewa_or_dcdt_payment(),
            gas_limit,
            &fc.function_name,
        ...
        F: FnOnce(&ManagedAddress<Env::Api>, &BigUint<Env::Api>, FunctionCall<Env::Api>) -> R,
    {
        ...
        to.with_address_ref(env, |to_addr| {
            let fc_conv =
                fc.convert_to_multi_transfer_dcdt_call(to_addr, pv.as_multi_rewa_or_dcdt_payment());
    ...
    fn into_full_payment_data(self, _env: &Env) -> FullPaymentData<Env::Api> {
        ...
        FullPaymentData {
            rewa: None,
            multi_dcdt: pv.as_multi_rewa_or_dcdt_payment().clone(),
        }
    }
}
