...
const DELEGATION_MANAGER_SC_ADDRESS_ANNOTATION: &str =
    "bech32:drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqylllsz8he8y";

/// Indicates the delegation manager SC address, which is the same on any DharitrI blockchain.
