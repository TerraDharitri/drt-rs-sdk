...
use crate::{
    ...
    codec,
    types::{
        system_proxy, BigUint, ContractCallNoPayment, DCDTSystemSCAddress, DcdtTokenPayment,
        FunctionCall, GasLeft, ManagedAddress, ManagedArgBuffer, ManagedBuffer, ManagedType,
        ManagedVec, NotPayable, OriginalResultMarker, ReturnsRawResult, ReturnsResult,
        RewaOrDcdtTokenIdentifier, ToSelf, TokenIdentifier, Tx, TxScEnv,
    },
};
    ...
    A: CallTypeApi + StorageReadApi + BlockchainApi,
{
    ...
    /// Prepares a proxy object to call the DCDT system SC.
    ...
    ///
    /// Note that REWA can NOT be transferred with this function.  
    ...
    /// Recreates an DCDT token with the newly specified attributes.
    #[allow(clippy::too_many_arguments)]
    ...
    /// Updates an DCDT token with the newly specified attributes.
    #[allow(clippy::too_many_arguments)]
