...
use crate::{
    ...
    storage,
    types::{
        BackTransfers, BackTransfersLegacy, BigUint, CodeMetadata, DcdtLocalRoleFlags,
        DcdtTokenData, DcdtTokenType, ManagedAddress, ManagedBuffer, ManagedByteArray,
        ManagedRefMut, ManagedType, ManagedVec, RewaOrDcdtTokenIdentifier, RewaOrDcdtTokenPayment,
    ...
    A: BlockchainApi + ManagedTypeApi + ErrorApi,
{
    ...
    pub fn get_dcdt_token_type(
        ...
        _token_id: &RewaOrDcdtTokenIdentifier<A>,
        nonce: u64,
    ) -> DcdtTokenType {
        DcdtTokenType::based_on_token_nonce(nonce)
    }
    ...
    pub fn get_dcdt_token_data(
        ...
        let token_type = self.get_dcdt_token_type(address, &token_id.data, nonce);
