...
use crate::{
    ...
    types::{DcdtTokenIdentifier, ManagedType},
};
    ...
    SA: StorageMapperApi,
{
    pub fn set<T: TopEncode + TopDecode + NestedEncode + NestedDecode, M: ManagedTypeApi>(
        &self,
        token_id: &DcdtTokenIdentifier<M>,
        token_nonce: u64,
        attributes: &T,
    ) {
    ...
    fn set_mapping_value<M: ManagedTypeApi>(&self, token_id: &DcdtTokenIdentifier<M>, value: u8) {
    ...
    A: StorageAddress<SA>,
{
    ...
    fn has_mapping_value<M: ManagedTypeApi>(&self, token_id: &DcdtTokenIdentifier<M>) -> bool {
    ...
    fn get_mapping_value<M: ManagedTypeApi>(&self, token_id: &DcdtTokenIdentifier<M>) -> u8 {
        storage_get(self.build_key_token_id_mapping(token_id).as_ref())
    }

    fn is_empty_mapping_value<M: ManagedTypeApi>(&self, token_id: &DcdtTokenIdentifier<M>) -> bool {
