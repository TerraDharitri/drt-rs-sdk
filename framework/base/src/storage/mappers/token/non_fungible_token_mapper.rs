...
use crate::{
    ...
    types::{
        system_proxy::DCDTSystemSCProxy, DCDTSystemSCAddress, FunctionCall, ManagedVec,
        OriginalResultMarker, RewaPayment, Tx, TxScEnv,
    },
};
    ...
    SA: StorageMapperApi + CallTypeApi,
{
    ...
    pub fn meta_issue(
        ...
        Tx::new_tx_from_sc()
            .to(DCDTSystemSCAddress)
            .typed(DCDTSystemSCProxy)
            .register_meta_dcdt(issue_cost, &token_display_name, &token_ticker, properties)
    }
