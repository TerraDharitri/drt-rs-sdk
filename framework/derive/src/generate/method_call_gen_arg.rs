...
pub fn generate_call_method_arg_load(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #var_names = dharitri_sc::io::load_endpoint_args::<Self::Api, #var_types>(#var_names_str);
    }
}
...
pub fn load_call_result_args_snippet(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #call_result_var_names = dharitri_sc::io::load_endpoint_args::<Self::Api,#call_result_var_types>(
...
pub fn load_legacy_cb_closure_args_snippet(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #closure_var_names = dharitri_sc::io::load_multi_args_custom_loader::<Self::Api, _, #closure_var_types>(
...
pub fn load_cb_closure_args_snippet(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #closure_var_names = dharitri_sc::io::load_callback_closure_args::<
            Self::Api,
            #closure_var_types,
        >(#closure_var_names_str);
    }
