...
pub enum EIVersion {
    ...
    /// Latest VM Hooks version, released with VM 1.5 in January 2024: https://www.dharitri.org/release/release-sirius-v1-6-7
    ///
    /// It adds the new async call functionality (promises).
    V1_3,

    /// Hooks made available in the Spica release, November 12, 2024: https://www.dharitri.org/release/release-spica-v1-8-4-0
    #[default]
    V1_4,
