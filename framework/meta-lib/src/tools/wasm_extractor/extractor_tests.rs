...
(module $adder_wasm.wasm
  ...
  (func $_ZN13dharitri_sc2io16arg_nested_tuple15load_single_arg17hcaef680f5560198bE (;11;) (type 1) (result i32)
    (local i32)
    i32.const 0
    call $_ZN26dharitri_sc_wasm_adapter3api13managed_types19static_var_api_node11next_handle17h315bf8f89178ffe1E
    local.tee 0
    call $bigIntGetUnsignedArgument
    local.get 0
  )
  (func $_ZN26dharitri_sc_wasm_adapter3api13managed_types19static_var_api_node11next_handle17h315bf8f89178ffe1E (;12;) (type 1) (result i32)
    (local i32)
    i32.const 0
    i32.const 0
  ...
  (func $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17h8cbbe81aa680cf46E (;13;) (type 5) (param i32)
    block ;; label = @1
  ...
  (func $_ZN13dharitri_sc7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3set17h00fe05a7d5154b39E (;14;) (type 0) (param i32 i32)
    (local i32)
    call $_ZN26dharitri_sc_wasm_adapter3api13managed_types19static_var_api_node11next_handle17h315bf8f89178ffe1E
    local.tee 2
    local.get 1
  ...
  (func $_ZN13dharitri_sc7storage7mappers19single_value_mapper35SingleValueMapper$LT$SA$C$T$C$A$GT$3get17hb9977d4c8d45f0d8E (;15;) (type 7) (param i32) (result i32)
    (local i32)
    local.get 0
    call $_ZN26dharitri_sc_wasm_adapter3api13managed_types19static_var_api_node11next_handle17h315bf8f89178ffe1E
    local.tee 1
  ...
  (func $init (;17;) (type 4)
    ...
    call $checkNoPayment
    i32.const 1
    call $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17h8cbbe81aa680cf46E
    call $_ZN13dharitri_sc2io16arg_nested_tuple15load_single_arg17hcaef680f5560198bE
    local.set 0
    call $_ZN34_$LT$C$u20$as$u20$adder..Adder$GT$3sum17h7cc7cc0602a1f97fE
    local.get 0
    call $_ZN13dharitri_sc7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3set17h00fe05a7d5154b39E
  )
  (func $getSum (;18;) (type 4)
    ...
    call $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17h8cbbe81aa680cf46E
    call $_ZN34_$LT$C$u20$as$u20$adder..Adder$GT$3sum17h7cc7cc0602a1f97fE
    call $_ZN13dharitri_sc7storage7mappers19single_value_mapper35SingleValueMapper$LT$SA$C$T$C$A$GT$3get17hb9977d4c8d45f0d8E
...
(module $empty_wasm.wasm
	...
	(func $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17hd731b4a37a0ab09aE (;3;) (type 2)
		block ;; label = @1
			call $getNumArguments
			br_if 0 (;@1;)
			return
	...
	(func $__rust_alloc (;4;) (type 2)
		call $_ZN122_$LT$dharitri_sc_wasm_adapter..wasm_alloc..fail_allocator..FailAllocator$u20$as$u20$core..alloc..global..GlobalAlloc$GT$5alloc17hf044a79dd04bdcb1E
		unreachable
	)
	(func $_ZN122_$LT$dharitri_sc_wasm_adapter..wasm_alloc..fail_allocator..FailAllocator$u20$as$u20$core..alloc..global..GlobalAlloc$GT$5alloc17hf044a79dd04bdcb1E (;5;) (type 2)
		call $_ZN26dharitri_sc_wasm_adapter10wasm_alloc14fail_allocator29signal_allocation_not_allowed17hb15b243b5f851b48E
		unreachable
	)
	(func $init (;6;) (type 2)
		call $checkNoPayment
		call $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17hd731b4a37a0ab09aE
		i32.const 0
	...
	(func $_ZN26dharitri_sc_wasm_adapter10wasm_alloc14fail_allocator29signal_allocation_not_allowed17hb15b243b5f851b48E (;9;) (type 2)
		i32.const 131097
		i32.const 27
		call $signalError
		unreachable
...
(module $empty_wasm.wasm
	...
	(func $_ZN13dharitri_sc2io16arg_nested_tuple22check_num_arguments_eq17hd731b4a37a0ab09aE (;4;) (type 2)
		block ;; label = @1
			call $getNumArguments
			br_if 0 (;@1;)
			return
	...
	(func $rust_begin_unwind (;5;) (type 2)
		call $_ZN26dharitri_sc_wasm_adapter5panic9panic_fmt17he68b14ffa9b6b21eE
		unreachable
	)
	(func $_ZN26dharitri_sc_wasm_adapter5panic9panic_fmt17he68b14ffa9b6b21eE (;6;) (type 2)
		i32.const 131097
		i32.const 14
		call $signalError
		unreachable
