...
impl InterpretableFrom<DcdtInstanceRaw> for DcdtInstance {
    fn interpret_from(from: DcdtInstanceRaw, context: &InterpreterContext) -> Self {
        DcdtInstance {
...
impl IntoRaw<DcdtInstanceRaw> for DcdtInstance {
    fn into_raw(self) -> DcdtInstanceRaw {
        DcdtInstanceRaw {
