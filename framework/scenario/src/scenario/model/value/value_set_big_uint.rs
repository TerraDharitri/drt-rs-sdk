...
use crate::dharitri_sc::api::ManagedTypeApi;
...
impl<M: ManagedTypeApi> From<crate::dharitri_sc::types::BigUint<M>> for BigUintValue {
    fn from(from: crate::dharitri_sc::types::BigUint<M>) -> Self {
...
impl<M: ManagedTypeApi> From<crate::dharitri_sc::types::AnnotatedRewaPayment<M>> for BigUintValue {
