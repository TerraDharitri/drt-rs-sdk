use dharitri_chain_vm::{blockchain::state::BlockchainState, schedule::GasScheduleVersion};
...
use dharitri_sc_meta_lib::tools::find_current_workspace;
...
impl ScenarioWorld {
    ...
    pub fn create_aggregated_signature(
        ...
        (dharitri_chain_vm::G1, Vec<dharitri_chain_vm::G2>),
        dharitri_chain_vm::BlsError,
    > {
        dharitri_chain_vm::crypto_functions_bls::create_aggregated_signature(pk_size, message)
    }
}
