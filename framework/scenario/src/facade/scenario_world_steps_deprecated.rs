...
impl ScenarioWorld {
    ...
    pub fn denali_set_state(&mut self, step: SetStateStep) -> &mut Self {
        self.set_state_step(step)
    }

    #[deprecated(since = "0.39.0", note = "Renamed, use `sc_call_step` instead.")]
    pub fn denali_sc_call(&mut self, step: ScCallStep) -> &mut Self {
        self.sc_call(step)
    }

    #[deprecated(since = "0.39.0", note = "Renamed, use `sc_query_step` instead.")]
    pub fn denali_sc_query(&mut self, step: ScQueryStep) -> &mut Self {
        self.sc_query(step)
    }

    #[deprecated(since = "0.39.0", note = "Renamed, use `sc_deploy_step` instead.")]
    pub fn denali_sc_deploy(&mut self, step: ScDeployStep) -> &mut Self {
        self.sc_deploy(step)
    }

    #[deprecated(since = "0.39.0", note = "Renamed, use `transfer_step` instead.")]
    pub fn denali_transfer(&mut self, step: TransferStep) -> &mut Self {
    ...
    pub fn denali_validator_reward(&mut self, step: ValidatorRewardStep) -> &mut Self {
        self.validator_reward_step(step)
    }

    #[deprecated(since = "0.39.0", note = "Renamed, use `check_state_step` instead.")]
    pub fn denali_check_state(&mut self, step: CheckStateStep) -> &mut Self {
