...
use crate::{
    ...
    dharitri_sc::{
        ...
        types::{DcdtLocalRole, heap::Address},
    },
...
use dharitri_chain_vm::host::context::{TxFunctionName, TxResult};
use dharitri_sc::types::{BigUint, H256, TimestampMillis, TimestampSeconds};
use num_traits::Zero;
...
pub use dharitri_chain_vm::host::context::TxTokenTransfer;
...
impl BlockchainStateWrapper {
    ...
    pub fn set_dcdt_balance(
        ...
        self.world
            .set_dcdt_balance(address, token_id, BigUint::from(balance));
    }
    ...
    pub fn set_dcdt_local_roles(
        ...
        self.world.set_dcdt_local_roles(address, token_id, roles);
    }
...
impl BlockchainStateWrapper {
    ...
    pub fn execute_dcdt_multi_transfer<CB, ContractObjBuilder, TxFn>(
        &mut self,
        caller: &Address,
        sc_wrapper: &ContractObjWrapper<CB, ContractObjBuilder>,
        ...
        TxFn: FnOnce(CB),
    {
        ...
        for dcdt_payment in &dcdt_payments {
            sc_call_step = sc_call_step.dcdt_transfer(
                dcdt_payment.token_identifier.as_slice(),
                dcdt_payment.nonce,
                &dcdt_payment.value,
            );
        }
        ...
        self.world
            ...
            .perform_sc_call_lambda_and_check(
                &sc_call_step,
                ContractDebugWhiteboxLambda::new(TxFunctionName::WHITEBOX_LEGACY, || {
                    tx_fn(sc);
                })
                .panic_message(false),
            )
