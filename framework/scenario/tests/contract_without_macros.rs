...
mod sample_adder {
    ...
    impl dharitri_sc::contract_base::ContractAbiProvider for AbiProvider {
        ...
        fn abi() -> dharitri_sc::abi::ContractAbi {
            ...
            endpoint_abi
                .add_output::<SingleValueMapper<Self::Api, dharitri_sc::types::BigUint<Self::Api>>>(
                    &[],
                );
            contract_abi
        ...
        dharitri_sc::contract_base::ProxyObjBase + super::module_1::ProxyTrait
    {
        ...
        #[allow(clippy::too_many_arguments)]
        #[allow(clippy::type_complexity)]
        fn upgrade<Arg0: dharitri_sc::types::ProxyArg<dharitri_sc::types::BigUint<Self::Api>>>(
            &mut self,
            initial_value: Arg0,
        ) -> dharitri_sc::types::Tx<
            dharitri_sc::types::TxScEnv<Self::Api>,
...
fn contract_without_macros_basic() {
    ...
    assert_eq!(dharitri_sc::types::BigUint::from(12u32), adder.sum().get());
