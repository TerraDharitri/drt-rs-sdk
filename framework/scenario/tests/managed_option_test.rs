...
use dharitri_sc::{
    api::ManagedTypeApi,
    types::{
        BigInt, BigUint, DcdtTokenIdentifier, ManagedAddress, ManagedBuffer, ManagedByteArray,
...
fn test_some() {
    ...
    test_some_for_value(|| DcdtTokenIdentifier::<StaticApi>::from(&b"TOKEN-000006"[..]));
}
...
fn test_none() {
    ...
    test_none_for_type::<StaticApi, DcdtTokenIdentifier<StaticApi>>();
}
