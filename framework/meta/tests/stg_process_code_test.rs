use dharitri_sc_meta::cmd::scen_test_gen::{DEFAULT_SETUP_GO, format_test_fn_go, process_code};

const GO_TEST_1: &str = r#"use dharitri_sc_scenario::imports::*;
...
const GO_TEST_0_1_2: &str = r#"use dharitri_sc_scenario::imports::*;
