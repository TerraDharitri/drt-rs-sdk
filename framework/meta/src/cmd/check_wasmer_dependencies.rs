...
use dharitri_sc_meta_lib::contract::sc_config::ExecuteCommandError;

const WASMER_CRATE_NAME: &str = "dharitri-vm-executor-wasmer ";
const WASMER_EXPERIMENTAL_CRATE_NAME: &str = "dharitri-vm-executor-wasmer-experimental ";
