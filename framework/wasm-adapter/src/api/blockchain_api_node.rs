...
unsafe extern "C" {
    ...
    fn managedGetDCDTTokenType(addressHandle: i32, tokenIDHandle: i32, nonce: i64, typeHandle: i32);
...
impl BlockchainApiImpl for VmApiImpl {
    ...
    fn managed_get_dcdt_token_type(
        ...
        unsafe {
            managedGetDCDTTokenType(address_handle, token_id_handle, nonce as i64, dest_handle);
        }
    }
}
