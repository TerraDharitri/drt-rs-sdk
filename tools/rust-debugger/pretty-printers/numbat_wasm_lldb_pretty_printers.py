...
DEBUG_API_TYPE = "numbat_wasm_debug::tx_mock::tx_context_ref::TxContextRef"
ANY_NUMBER = "[0-9]+"
ANY_TYPE = ".*"
...
MOD_PATH = "numbat_wasm::types::managed::basic"
...
MOD_PATH = "numbat_wasm::types::managed::wrapped"
...
# 5. Numbat wasm - heap
MOD_PATH = "numbat_wasm::types::heap"
...
MOD_PATH = "numbat_codec::multi_types"
...
def __lldb_init_module(debugger: SBDebugger, dict):
    ...
    for rust_type, handler_class in NUMBAT_WASM_TYPE_HANDLERS:
        ...
        summary_command = f'type summary add -x "^{rust_type}$" -F {python_module_name}.{summary_function_name} --category numbat-wasm'
        debugger.HandleCommand(summary_command)
        # print(f"Registered: {summary_command}")

    # Enable categories
    debugger.HandleCommand('type category enable numbat-wasm')
