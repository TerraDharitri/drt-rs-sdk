...
These are the release descriptions that are going up on [the DharitrI releases page](https://dharitri.org/releases/wasm)
...
Then, whoever is responsible with the public releases web page should add them to [the DharitrI releases page](https://dharitri.org/releases/wasm) as well.
