...
Implementing them turned out trickier than expected, since we couldn't find an exact Rust equivalent of the library used in the Go VM. Therefore, we needed to heavily adapt an existing one ([herumi/bls-eth-rust](https://github.com/herumi/bls-eth-rust)) as [drt-bls-rs](https://github.com/TerraDharitri/drt-bls-rs).
