...
Rust 1.87 has migrated to LLVM 20, which by default adds memory copy and fill opcodes to smart contracts. These opcodes are not yet supported by the DharitrI Space VM.
