...
Before the unified transaction syntax, there used to be a Denali-based syntax for tests and interactors. It was unsuccessful, and barely used. At that point the oldest testing framework was still popular and remained widespread.

People only started to migrate tests once the unified syntax was introduced. The denali-based solution has been deprecated for more than 2 years, and we are not aware of anyone using it. To simplify our codebase, we removed some of this code.
