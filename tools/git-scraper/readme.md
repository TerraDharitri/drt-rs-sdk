# Git scraping tool for DharitrI example contracts.

## Overview

The aim of this tool is to scrape the source code of example contracts from the DharitrI GitHub repository and save it to a file that serves as training data for AI models.
...
1. Generate a new GitHub Token [here](https://github.com/settings/tokens)
   ...
   - Set expiration to a value less than 365 days (drt limit)
...
Run the tool from the drt-rs-sdk root directory using:
```bash
