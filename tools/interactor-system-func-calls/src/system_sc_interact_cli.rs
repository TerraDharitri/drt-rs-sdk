...
use dharitri_sc_snippets::{imports::*, dharitri_sc::proxy_imports::*};
...
pub enum InteractCliCommand {
    ...
    MintSft(MintSFTArgs),
    #[command(name = "register-meta-dcdt", about = "Registers a meta DCDT")]
    RegisterMetaDcdt(RegisterMetaDcdtArgs),
    #[command(name = "change-sft-meta-dcdt", about = "Changes a SFT to a Meta DCDT")]
    ChangeSftMetaDcdt(ChangeSftMetaDcdtArgs),
...
#[derive(Clone, Debug, PartialEq, Eq, Args)]
pub struct RegisterMetaDcdtArgs {
    #[arg(short = 'c', long = "cost", default_value = "50000000000000000")]
    pub cost: RustBigUint,
    #[arg(short = 'd', long = "display-name")]
    pub display_name: String,
...
#[derive(Clone, Debug, PartialEq, Eq, Args)]
pub struct ChangeSftMetaDcdtArgs {
    #[arg(long = "token-id")]
    pub token_id: String,
    #[arg(long = "num-decimals")]
    pub num_decimals: usize,
