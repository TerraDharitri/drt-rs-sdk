...
use dharitri_sc_scenario::scenario_format::interpret_trait::{InterpreterContext, IntoRaw};
use dharitri_sc_scenario::scenario_model::Step;
...
pub fn create_scenario() -> Scenario {
    let mut scenario = Scenario::default()
        .with_comment("Code generated by drt-rs-sdk/tools/op-test-gen. DO NOT EDIT.");
