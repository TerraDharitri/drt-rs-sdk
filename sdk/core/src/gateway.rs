mod gateway_account;
mod gateway_account_dcdt_roles;
mod gateway_account_dcdt_tokens;
...
pub use gateway_account_dcdt_roles::GetAccountDcdtRolesRequest;
pub use gateway_account_dcdt_tokens::GetAccountDcdtTokensRequest;
