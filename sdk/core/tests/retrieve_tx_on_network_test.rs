    ...
    let tx_str = r#"
{
    ...
    "epoch": 2296,
    "value": "0",
    "receiver": "drt17skvj6nlmx3ywa8d4l74s5pg6c5sd4a775y0up2ahhrwz6w5rkksc82th9",
    "sender": "drt17skvj6nlmx3ywa8d4l74s5pg6c5sd4a775y0up2ahhrwz6w5rkksc82th9",
    "gasPrice": 1000000000,
    "gasLimit": 1276500,
    "gasUsed": 1276500,
    ...
    "logs": {
        "address": "drt17skvj6nlmx3ywa8d4l74s5pg6c5sd4a775y0up2ahhrwz6w5rkksc82th9",
        "events": [
          {
            "address": "drt17skvj6nlmx3ywa8d4l74s5pg6c5sd4a775y0up2ahhrwz6w5rkksc82th9",
            "identifier": "signalError",
    ...
    "receivers": [
        "drt1ph665853r9xhc3hys90kzku2eal60s5ma0zgtpganc30mkd88rtsadenmq"
    ],
    "receiversShardIDs": [
        1
    ],
    ...
    let tx_str = r#"
{
    ...
    "epoch": 2422,
    "value": "0",
    "receiver": "drt1qqqqqqqqqqqqqpgqw2nyvcua0wa6dnq2cc7vcm2dewghlsauv0ws7tmx2h",
    "sender": "drt1m63u4asyua53ghpqxlj4qfmtceg9m23mcejz92eddq6qd8k2s48smgzrzx",
    "gasPrice": 1000000000,
    "gasLimit": 80000000,
    "gasUsed": 80000000,
    ...
    "smartContractResults": [
        {
          ...
          "sender": "drt1qqqqqqqqqqqqqpgqw2nyvcua0wa6dnq2cc7vcm2dewghlsauv0ws7tmx2h",
          ...
          "gasPrice": 1000000000,
          "callType": 1,
          "originalSender": "drt1m63u4asyua53ghpqxlj4qfmtceg9m23mcejz92eddq6qd8k2s48smgzrzx",
          "logs": {
            "address": "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqphllllsw34xxl",
            "events": [
              {
                "address": "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqphllllsw34xxl",
                "identifier": "signalError",
        ...
        },
        {
          ...
          "value": 0,
          "receiver": "drt1qqqqqqqqqqqqqpgqw2nyvcua0wa6dnq2cc7vcm2dewghlsauv0ws7tmx2h",
          "sender": "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqphllllsw34xxl",
          ...
          "logs": {
            "address": "drt1qqqqqqqqqqqqqpgqw2nyvcua0wa6dnq2cc7vcm2dewghlsauv0ws7tmx2h",
            "events": [
              {
                "address": "drt1qqqqqqqqqqqqqpgqw2nyvcua0wa6dnq2cc7vcm2dewghlsauv0ws7tmx2h",
                "identifier": "callBack",
...
fn replace_logs_reason_sc_panic_test() {
    let tx_str = r#"
    {
      ...
      "epoch": 2422,
      "value": "0",
      "receiver": "drt1qqqqqqqqqqqqqpgq965hzhtvu6glhf7t4vcqpmssfxhssplea2ws49qgpz",
      "sender": "drt1akawdpkphvrwg5vn3fxyqg0tghzkumzugwutqyy0ew8xalfaa2wsvl3q5m",
      "gasPrice": 1000000000,
      "gasLimit": 39000000,
      "gasUsed": 39000000,
      ...
      "logs": {
        "address": "drt1qqqqqqqqqqqqqpgq965hzhtvu6glhf7t4vcqpmssfxhssplea2ws49qgpz",
        "events": [
          {
            "address": "drt1qqqqqqqqqqqqqpgq965hzhtvu6glhf7t4vcqpmssfxhssplea2ws49qgpz",
            "identifier": "signalError",
          ...
          {
            "address": "drt1akawdpkphvrwg5vn3fxyqg0tghzkumzugwutqyy0ew8xalfaa2wsvl3q5m",
    ...
    let tx_str = r#"
{
    ...
    "epoch": 2419,
    "value": "0",
    "receiver": "drt1qqqqqqqqqqqqqpgqhdqz9j3zgpl8fg2z0jzx9n605gwxx4djd8ss7qevxt",
    ...
    "logs": {
        "address": "drt1qqqqqqqqqqqqqpgqhdqz9j3zgpl8fg2z0jzx9n605gwxx4djd8ss7qevxt",
        "events": [
          {
            "address": "drt1qqqqqqqqqqqqqpgqhdqz9j3zgpl8fg2z0jzx9n605gwxx4djd8ss7qevxt",
            "identifier": "signalError",
